...
export interface IJokeCommand extends ICommand {
  generationType: string;
  findType: string;
  findTypeSize: number;
}
  
export class JokeCommand implements IJokeCommand {
            ...
            if(this.findTypeSize == 0){
              try {
                const quote = {
                  ...
                  "jokeTimestamp": message.createdTimestamp,
                ...
                //Sort the quotes
                fs.writeFileSync('jokes.json', JSON.stringify(userArray));
